...
const db = mysql.createConnection({
  host: "tramway.proxy.rlwy.net",   // 👈 Replace with actual host
  user: "root",                 // 👈 From Railway
  password: "ZBzsYvGpOWTbjZuWpHdrdDsocJzoLsYf",         // 👈 From Railway
  database: "railway",         // 👈 From Railway
  port: 3306                         // 👈 Often 3306 (double-check in Railway)
});
