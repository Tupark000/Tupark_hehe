...
//               title: Text(
//                 _selectedDateTime == null
//                     ? "Pick expected time-in"
//                     : "Expected Time: ${DateFormat.yMd().add_jm().format(_selectedDateTime!)}",
//               ),
...
//     // Listen to entrance WebSocket for scanning UID
...
//   @override
//   void dispose() {
//     ApiService.disposeWebSockets(); // Stop listening
//     super.dispose();
//   }
